    ...
    <div className="min-h-screen bg-[#020617] text-white flex flex-col font-sans relative overflow-x-hidden selection:bg-blue-500/30 selection:text-blue-100">
          ...
          <div className="flex items-center h-full gap-4 md:gap-10">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <button 
                ...
                className="bg-slate-800/50 text-slate-300 md:bg-transparent md:text-white px-6 md:px-8 py-2 md:py-3 rounded-full font-sans font-medium text-[13px] md:text-[14px] hover:bg-slate-800 transition-colors shadow-sm md:shadow-none"
              >
                Home
              </button>
            </div>
      ...
      <footer className="w-full mt-auto relative z-10 overflow-hidden pt-20 pb-12 px-6 border-t border-slate-800/50 flex justify-center">
        <div className="w-full max-w-[1400px] relative flex flex-col">
          ...
          <div className="w-full flex justify-center sm:justify-end gap-6 sm:gap-8 lg:gap-10 text-[11px] sm:text-[13px] text-slate-500 font-mono tracking-wide mt-8 sm:mt-4 md:-mt-4 lg:-mt-8 relative z-20 sm:pr-8 md:pr-12 lg:pr-20">
